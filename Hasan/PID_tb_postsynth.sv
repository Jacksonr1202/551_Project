...
module PID_tb_postsynth;
  ...
  initial begin
    ...
    //keep reset asserted through a posedge and a negedge, then deassert on negedge.
    @(posedge clk);
    @(negedge clk);
    rst_n = 1'b1;
    ...
    if (errors == 0)
      ...
      $display("FAIL: %0d mismatches found in post-synthesis simulation.", errors);
